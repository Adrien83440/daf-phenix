...
(function () {
  ...
  (async function () {
    try {
      ...
      await wait(function () { return !$("btn-nova").classList.contains("locked"); });
      ok(!$("btn-live").hidden && /Parler à Nova/.test($("btn-nova").textContent), "Nova : déverrouillée après la vérification du compte (premium)");
