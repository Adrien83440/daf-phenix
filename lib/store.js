...
//  Moteur mémoire
// ---------------------------------------------------------------------------
const mem = { clients: new Map(), revoked: new Set(), runs: new Map(), days: new Map(), clientStats: new Map(), events: [] };
...
function _reset() { mem.clients.clear(); mem.revoked.clear(); mem.runs.clear(); mem.days.clear(); mem.clientStats.clear(); mem.events.length = 0; }

module.exports = { backend, today, dayList, saveClient, getClient, listClients, deleteClient, setRevoked, isRevoked, revokedList, consumeRun, quotaUsed, record, traced, events, dayStats, clientStats, ping, STAT_FIELDS, _reset };
